...
AUREFACE_BYTES = 260_694_151
AUREFACE_SHA256 = "a7933ea5330113b01c9b60351d8f4c33003f145d8470ac5f0e52ee2effe25c60"
YUnET_BYTES = 232_589
...
def run(frame, yunet_path, auraface_path):
    ...
    aligned = cv2.warpAffine(frame, transform, (112, 112), flags=cv2.INTER_LINEAR, borderMode=cV2.BORDER_CONSTANT, borderValue=0)
    if aligned is None or aligned.shape != (112, 112, 3):
        fail("alignment_output_invalid", "aligned face must be 112x112x3")
    blob = cV2.dnn.blobFromImage(aligned, scalefactor=1.0 / 127.5, size=(112, 112), mean=(127.5, 127.5, 127.5), swapRB=True, crop=False, ddepth=cv2.CV_32F)
...
def main():
    ...
    verify_model(args.auraface, AUREFACE_BYTES,
                 AUREFACE_SHA256, "auraface")
