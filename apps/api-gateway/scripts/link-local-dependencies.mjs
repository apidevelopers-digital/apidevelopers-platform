...
const links = Object.freeze([
  ...
  ["apps/api-gateway", "trust-biometric-adapter-contract"],
  ["apps/api-gateway", "trust-biometric-adapter-aws"],
  ...
  ["packages/trust-biometric-adapter-aws", "trust-biometric-adapter-contract"],
